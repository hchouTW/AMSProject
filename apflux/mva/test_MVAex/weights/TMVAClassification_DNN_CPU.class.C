...
NVar 4
lxex                          lxex                          lxex                          lxex                          units                             'F'    [-5.76041173935,2.93556642532]
lyex                          lyex                          lyex                          lyex                          units                             'F'    [-6.57445478439,3.21065163612]
dxex                          dxex                          dxex                          dxex                          units                             'F'    [-1.22807359695,12.5565776825]
dyex                          dyex                          dyex                          dyex                          units                             'F'    [-0.69030725956,8.5900888443]
NSpec 0
...
class ReadDNN_CPU : public IClassifierReader {
 ...
 public:
        ...
        fNvars( 4 )
   {
      ...
      const char* inputVars[] = { "lxex", "lyex", "dxex", "dyex" };
