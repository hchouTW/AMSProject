...
int main(int argc, char* argv[]) {
    ...
    TFile* ftme_appr = TFile::Open(Form("out/apflux_tme%s.root", subt.c_str()));
    ...
    Hist* hTR_appr = Hist::New("hTR_appr", (TH2D*)(ftme_appr->Get("hTAppTotl")));
    ...
    const double DEF_PERIOD = 9.0;
    
    PdfEditor editor(Window(), Form("phys_tme%s", subt.c_str()), "out");
    ...
    tfunc_psel->SetParLimits(2, -2.0, 2.0);
    tfunc_psel->SetParLimits(3,  6.0, 14.0);
    ...
    for (int ir = 1; ir <= AXrig_psel.nbin(); ++ir) {
        ...
        tfunc_psel->FixParameter(2, DEF_REVTME);
        tfunc_psel->FixParameter(3, DEF_PERIOD);
        (*hpsel)()->Fit(tfunc_psel, "q0", "", AXtme_psel.min(), AXtme_psel.max());
        (*hpsel)()->Fit(tfunc_psel, "q0", "", AXtme_psel.min(), AXtme_psel.max());
        (*hpsel)()->Fit(tfunc_psel, "q0", "", AXtme_psel.min(), AXtme_psel.max());
        
        tfunc_psel->ReleaseParameter(2);
        tfunc_psel->SetParLimits(2, -2.0, 2.0);
        (*hpsel)()->Fit(tfunc_psel, "q0", "", AXtme_psel.min(), AXtme_psel.max());
        (*hpsel)()->Fit(tfunc_psel, "q0", "", AXtme_psel.min(), AXtme_psel.max());
        (*hpsel)()->Fit(tfunc_psel, "q0", "", AXtme_psel.min(), AXtme_psel.max());
        
        tfunc_psel->ReleaseParameter(3);
        tfunc_psel->SetParLimits(3, 6.0, 14.0);
        (*hpsel)()->Fit(tfunc_psel, "q0", "", AXtme_psel.min(), AXtme_psel.max());
        (*hpsel)()->Fit(tfunc_psel, "q0", "", AXtme_psel.min(), AXtme_psel.max());
        (*hpsel)()->Fit(tfunc_psel, "q0", "", AXtme_psel.min(), AXtme_psel.max());
    ...
    tfunc_appr->SetParLimits(2, -2.0, 2.0);
    tfunc_appr->SetParLimits(3,  6.0, 14.0);
    ...
    for (int ir = 1; ir <= AXrig_appr.nbin(); ++ir) {
        ...
        tfunc_appr->FixParameter(2, DEF_REVTME);
        tfunc_appr->FixParameter(3, DEF_PERIOD);
        (*happr)()->Fit(tfunc_appr, "q0", "", AXtme_appr.min(), AXtme_appr.max());
        (*happr)()->Fit(tfunc_appr, "q0", "", AXtme_appr.min(), AXtme_appr.max());
        (*happr)()->Fit(tfunc_appr, "q0", "", AXtme_appr.min(), AXtme_appr.max());
        
        tfunc_appr->ReleaseParameter(2);
        tfunc_appr->SetParLimits(2, -2.0, 2.0);
        (*happr)()->Fit(tfunc_appr, "q0", "", AXtme_appr.min(), AXtme_appr.max());
        (*happr)()->Fit(tfunc_appr, "q0", "", AXtme_appr.min(), AXtme_appr.max());
        (*happr)()->Fit(tfunc_appr, "q0", "", AXtme_appr.min(), AXtme_appr.max());
        
        tfunc_appr->ReleaseParameter(3);
        tfunc_appr->SetParLimits(3, 6.0, 14.0);
        (*happr)()->Fit(tfunc_appr, "q0", "", AXtme_appr.min(), AXtme_appr.max());
        (*happr)()->Fit(tfunc_appr, "q0", "", AXtme_appr.min(), AXtme_appr.max());
        (*happr)()->Fit(tfunc_appr, "q0", "", AXtme_appr.min(), AXtme_appr.max());
    ...
    editor.cd(1, PadAxis(1));
    hKEReftme->draw();
    hTpselKE_reftme->draw("pe same");
    hTapprKE_reftme->draw("pe same");
    leg_reftme.draw();
    editor.save();
    ...
    TFile * ofle = new TFile(Form("out/phys_tme%s.root", subt.c_str()), "RECREATE");
    ofle->cd();
