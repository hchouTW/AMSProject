...
bool Analyzer::build_hist() {
    ...
    std::vector<double> vtme1M( { // 1-BR
        ...
        1541030400, 1543363200, 1545696000, // 7.5 years
        1548028800, 1550361600, 1552694400, 1555027200, 1557360000, 1559692800, 1562025600, 1564358400, 1566691200, 1569024000, 
        1571356800, 1573689600
        } );
    std::vector<double> vtme2M( { // 2-BR
        ...
        1541030400, 1545696000, // 7.5 years
        1550361600, 1555027200, 1559692800, 1564358400, 1569024000,
        1573689600
        } );
    std::vector<double> vtme3M( { // 3-BR
        ...
        1517702400, 1524700800, 1531699200, 1538697600, 1545696000, // 7.5 years
        1552694400, 1559692800, 1566691200, 1573689600
        } );
    std::vector<double> vtme6M( { // 6-BR
        ...
        1517702400, 1531699200, 1545696000, // 7.5 years
        1559692800, 1573689600
        } );
    std::vector<double> vtme1Y( { // 12-BR
        1307750400, 1335744000, 1363737600, 1391731200, 1419724800, 
        1447718400, 1475712000, 1503705600, 1531699200, 1559692800
        } );
    Axis AXtme1M("Time", vtme1M);
    Axis AXtme2M("Time", vtme2M);
    Axis AXtme3M("Time", vtme3M);
    Axis AXtme6M("Time", vtme6M);
    Axis AXtme1Y("Time", vtme1Y);
    ...
    std::vector<double> vrig_tme_v2( {
        ...
        45.10 } );
    std::vector<double> vrig_tme_v3( {
        1.00,  1.51,  1.92,  2.97,  3.64,  4.43,  5.37,  6.47,  7.76,  9.26,  
       11.00, 13.00, 15.30, 18.00, 21.10, 24.70, 28.80, 33.50, 38.90, 45.10 } );
    
    Axis AXrig ("|Rigidity| [GV]", vrig);
    Axis AXTrig("|Rigidity| [GV]", vrig_tme_v3);
    ...
    Hist::New("hT1YLtfP_sqrm",    HistAxis(AXtme1Y, AXTrig, AXTLTFsqrm));
    Hist::New("hT1YLtfN_sqrm",    HistAxis(AXtme1Y, AXTrig, AXTLTFsqrm));
    Hist::New("hT1YLtfP_sqrm_pr", HistAxis(AXtme1Y, AXTrig, AXTLTFsqrm));
    Hist::New("hT1YLtfN_sqrm_el", HistAxis(AXtme1Y, AXTrig, AXTLTFsqrm));
    ...
    Hist::New("hLtfP_cnt_MC", HistAxis(AXrig));
    Hist::New("hLtfN_cnt_MC", HistAxis(AXrig));
    Hist::New("hLtfP_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hLtfN_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hLtfP_cnt_MC_FLUX27", HistAxis(AXrig));
    Hist::New("hLtfN_cnt_MC_FLUX27", HistAxis(AXrig));
    
    Axis AXLRHsqrm ("Mass^{2}/Z^{2} [(GV/c^{2})^{2}]", 125, -1.0, 3.0);
    Axis AXTLRHsqrm("Mass^{2}/Z^{2} [(GV/c^{2})^{2}]",  75, -1.0, 3.0);
    ...
    Hist::New("hT1YLrhP_sqrm",    HistAxis(AXtme1Y, AXTrig, AXTLRHsqrm));
    Hist::New("hT1YLrhN_sqrm",    HistAxis(AXtme1Y, AXTrig, AXTLRHsqrm));
    Hist::New("hT1YLrhP_sqrm_pr", HistAxis(AXtme1Y, AXTrig, AXTLRHsqrm));
    Hist::New("hT1YLrhN_sqrm_el", HistAxis(AXtme1Y, AXTrig, AXTLRHsqrm));
    ...
    Hist::New("hLrhP_cnt_MC", HistAxis(AXrig));
    Hist::New("hLrhN_cnt_MC", HistAxis(AXrig));
    Hist::New("hLrhP_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hLrhN_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hLrhP_cnt_MC_FLUX27", HistAxis(AXrig));
    Hist::New("hLrhN_cnt_MC_FLUX27", HistAxis(AXrig));
    
    Axis AXIINllr ("TRD Estimator (#Lambda_{TRD})", 150, 0.1, 1.5);
    Axis AXTIINllr("TRD Estimator (#Lambda_{TRD})", 100, 0.1, 1.5);
    ...
    Hist::New("hT1YIinP_llr",    HistAxis(AXtme1Y, AXTrig, AXTIINllr));
    Hist::New("hT1YIinN_llr",    HistAxis(AXtme1Y, AXTrig, AXTIINllr));
    Hist::New("hT1YIinP_llr_pr", HistAxis(AXtme1Y, AXTrig, AXTIINllr));
    Hist::New("hT1YIinN_llr_el", HistAxis(AXtme1Y, AXTrig, AXTIINllr));
    ...
    Hist::New("hIinP_cnt_MC", HistAxis(AXrig));
    Hist::New("hIinN_cnt_MC", HistAxis(AXrig));
    Hist::New("hIinP_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hIinN_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hIinP_cnt_MC_FLUX27", HistAxis(AXrig));
    Hist::New("hIinN_cnt_MC_FLUX27", HistAxis(AXrig));
   
    Axis AXIEXllr ("TRD Estimator (#Lambda_{TRD})", 100, 0.1, 1.5);
    Axis AXTIEXllr("TRD Estimator (#Lambda_{TRD})", 100, 0.1, 1.5);
    ...
    Hist::New("hT1YIexP_llr",    HistAxis(AXtme1Y, AXTrig, AXTIEXllr));
    Hist::New("hT1YIexN_llr",    HistAxis(AXtme1Y, AXTrig, AXTIEXllr));
    Hist::New("hT1YIexP_llr_pr", HistAxis(AXtme1Y, AXTrig, AXTIEXllr));
    Hist::New("hT1YIexN_llr_el", HistAxis(AXtme1Y, AXTrig, AXTIEXllr));
    ...
    Hist::New("hIexP_cnt_MC", HistAxis(AXrig));
    Hist::New("hIexN_cnt_MC", HistAxis(AXrig));
    Hist::New("hIexP_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hIexN_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hIexP_cnt_MC_FLUX27", HistAxis(AXrig));
    Hist::New("hIexN_cnt_MC_FLUX27", HistAxis(AXrig));
    
    Axis AXHEXllr("TRD Estimator (#Lambda_{TRD})", 200, 0.0, 1.6);
    Axis AXHEXcc ("CC Estimator (#Lambda_{CC})", 100, -1, 1);
    Axis AXHEXchi("#chi^{2}/NDF", 50, -4, 4);
    ...
    Hist::New("hHexP_cnt_MC", HistAxis(AXrig));
    Hist::New("hHexN_cnt_MC", HistAxis(AXrig));
    Hist::New("hHexP_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hHexN_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hHexP_cnt_MC_FLUX27", HistAxis(AXrig));
    Hist::New("hHexN_cnt_MC_FLUX27", HistAxis(AXrig));
    
    Axis AXHFSllr("TRD Estimator (#Lambda_{TRD})", 200, 0.0, 1.6);
    Axis AXHFScc ("CC Estimator (#Lambda_{CC})", 50, -1, 1);
    Axis AXHFSchi("#chi^{2}/NDF", 50, -4, 4);
    ...
    Hist::New("hHfsP_cnt_MC", HistAxis(AXrig));
    Hist::New("hHfsN_cnt_MC", HistAxis(AXrig));
    Hist::New("hHfsP_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hHfsN_cnt_MC_FLUX10", HistAxis(AXrig));
    Hist::New("hHfsP_cnt_MC_FLUX27", HistAxis(AXrig));
    Hist::New("hHfsN_cnt_MC_FLUX27", HistAxis(AXrig));
...
bool Analyzer::process_data_ltf() {
    ...
    double cfib = std::hypot(1.0, 1.0/vars->cfevt);
    //double cfib = std::hypot(1.0, 1.0/vars->cfsec);
    ...
    bool is_like_pr_ecal = (vars->ecal && vars->mvaBDT < -0.6);
    bool is_like_el_ecal = (vars->ecal && vars->mvaBDT >  0.2);
    if (vars->ecal && vars->mvaBDT > -0.6) return false;
    ...
    bool is_like_el_rich = (vars->rich_el && vars->nhinn == 0 && vars->nhout <= 3);
    bool is_like_pr = (vars->llr > (0.75 * vars->bta) && is_like_pr_rich);
    bool is_like_el = (vars->llr < (0.65 * vars->bta) && is_like_el_rich);
     
    // Cutoff
    double limit_cfr = 0.8;
    double lmtcfr = limit_cfr * 1.4;
    ...
    if (sign > 0 && is_like_pr) Hist::Head("hT1YLtfP_sqrm_pr")->fillH3D(vars->ut, arig, vars->sqrm, vars->wgt);
    if (sign < 0 && is_like_el) Hist::Head("hT1YLtfN_sqrm_el")->fillH3D(vars->ut, arig, vars->sqrm, vars->wgt);
    ...
    if (sign > 0) Hist::Head("hT1YLtfP_sqrm")->fillH3D(vars->ut, arig, vars->sqrm, vars->wgt);
    if (sign < 0) Hist::Head("hT1YLtfN_sqrm")->fillH3D(vars->ut, arig, vars->sqrm, vars->wgt);
    ...
    if (vars->mc && sign > 0) Hist::Head("hLtfP_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hLtfN_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hLtfP_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hLtfN_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hLtfP_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hLtfN_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
...
bool Analyzer::process_data_lrh() {
    ...
    bool is_like_pr = (vars->llr > 0.75 * vars->bta);
    bool is_like_el = (vars->llr < 0.65 * vars->bta);
    ...
    if (sign > 0 && is_like_pr) Hist::Head("hT1YLrhP_sqrm_pr")->fillH3D(vars->ut, arig, vars->sqrm, vars->wgt);
    if (sign < 0 && is_like_el) Hist::Head("hT1YLrhN_sqrm_el")->fillH3D(vars->ut, arig, vars->sqrm, vars->wgt);
    ...
    if (sign > 0) Hist::Head("hT1YLrhP_sqrm")->fillH3D(vars->ut, arig, vars->sqrm, vars->wgt);
    if (sign < 0) Hist::Head("hT1YLrhN_sqrm")->fillH3D(vars->ut, arig, vars->sqrm, vars->wgt);
    ...
    if (vars->mc && sign > 0) Hist::Head("hLrhP_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hLrhN_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hLrhP_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hLrhN_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hLrhP_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hLrhN_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
...
bool Analyzer::process_data_iin() {
    ...
    bool is_like_pr = (!vars->ecal || (vars->ecal && vars->mvaBDT < -0.6 && std::abs(vars->engD/vars->rig) < 0.4));
    ...
    if (sign > 0 && is_like_pr) Hist::Head("hT1YIinP_llr_pr")->fillH3D(vars->ut, arig, vars->llr, vars->wgt);
    if (sign < 0 && is_like_el) Hist::Head("hT1YIinN_llr_el")->fillH3D(vars->ut, arig, vars->llr, vars->wgt);
    ...
    if (sign > 0) Hist::Head("hT1YIinP_llr")->fillH3D(vars->ut, arig, vars->llr, vars->wgt);
    if (sign < 0) Hist::Head("hT1YIinN_llr")->fillH3D(vars->ut, arig, vars->llr, vars->wgt);
    ...
    if (vars->mc && sign > 0) Hist::Head("hIinP_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hIinN_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hIinP_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hIinN_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hIinP_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hIinN_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
...
bool Analyzer::process_data_iex() {
    ...
    // Tracker
    if (vars->optL2 == 0) return false;
    if (vars->nhL2 > 3) return false;
    ...
    if (sign > 0 && is_like_pr) Hist::Head("hT1YIexP_llr_pr")->fillH3D(vars->ut, arig, vars->llr, vars->wgt);
    if (sign < 0 && is_like_el) Hist::Head("hT1YIexN_llr_el")->fillH3D(vars->ut, arig, vars->llr, vars->wgt);
    ...
    if (sign > 0) Hist::Head("hT1YIexP_llr")->fillH3D(vars->ut, arig, vars->llr, vars->wgt);
    if (sign < 0) Hist::Head("hT1YIexN_llr")->fillH3D(vars->ut, arig, vars->llr, vars->wgt);
    ...
    if (vars->mc && sign > 0) Hist::Head("hIexP_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hIexN_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hIexP_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hIexN_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hIexP_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hIexN_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
...
bool Analyzer::process_data_hex() {
    ...
    if (arig > 147.0 && vars->patt == 1) return false;
    ...
    // TRD
    double llr_cut = 0.75 - 0.05 * std::erfc(3.0 * std::log(330.0 / arig));
    ...
    if (vars->mc && sign > 0) Hist::Head("hHexP_CF_cc_MC")->fillH2D(arig, cc, vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHexN_CF_cc_MC")->fillH2D(arig, cc, vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hHexP_CF_cc_MC_FLUX10")->fillH2D(arig, cc, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHexN_CF_cc_MC_FLUX10")->fillH2D(arig, cc, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hHexP_CF_cc_MC_FLUX27")->fillH2D(arig, cc, vars->mc_w27 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHexN_CF_cc_MC_FLUX27")->fillH2D(arig, cc, vars->mc_w27 * vars->wgt);
    ...
    if (vars->mc && sign > 0) Hist::Head("hHexP_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHexN_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hHexP_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHexN_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hHexP_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHexN_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
...
bool Analyzer::process_data_hfs() {
    ...
    if (vars->mc && sign > 0) Hist::Head("hHfsP_CF_cc_MC")->fillH2D(arig, cc, vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHfsN_CF_cc_MC")->fillH2D(arig, cc, vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hHfsP_CF_cc_MC_FLUX10")->fillH2D(arig, cc, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHfsN_CF_cc_MC_FLUX10")->fillH2D(arig, cc, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hHfsP_CF_cc_MC_FLUX27")->fillH2D(arig, cc, vars->mc_w27 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHfsN_CF_cc_MC_FLUX27")->fillH2D(arig, cc, vars->mc_w27 * vars->wgt);
    ...
    if (vars->mc && sign > 0) Hist::Head("hHfsP_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHfsN_cnt_MC")->fillH1D(arig, vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hHfsP_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHfsN_cnt_MC_FLUX10")->fillH1D(arig, vars->mc_w10 * vars->wgt);
    if (vars->mc && sign > 0) Hist::Head("hHfsP_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
    if (vars->mc && sign < 0) Hist::Head("hHfsN_cnt_MC_FLUX27")->fillH1D(arig, vars->mc_w27 * vars->wgt);
  

    if (sign < 0 && arig > 450.0 && arig < 525.0) {
        apcc = cc;
        if (apcc > 0.9 && vars->llr > 0.75) aptree->Fill();
    }
