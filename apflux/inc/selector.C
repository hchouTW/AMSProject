...
bool Selector::process_data_ltf() {
    ...
    varsLTF.br  = CheckType(Type::ISS) ? (UInt_t(2546) + ((list->utime - UInt_t(1305417600)) / UInt_t(2332800))) : 0;
    ...
    varsLTF.ecal   = ecal->status;
    varsLTF.mvaBDT = ecal->mvaBDT;
...
bool Selector::process_data_lrh() {
    ...
    varsLRH.br  = CheckType(Type::ISS) ? (UInt_t(2546) + ((list->utime - UInt_t(1305417600)) / UInt_t(2332800))) : 0;
    ...
    varsLRH.ecal   = ecal->status;
    varsLRH.mvaBDT = ecal->mvaBDT;
    
    varsLRH.lxin   = lchix_in;
    varsLRH.lyin   = lchiy_in;
    
    varsLRH.nhinn = rich->self_nhit_other_inn;
    varsLRH.nhout = rich->self_nhit_other_out;
...
bool Selector::process_data_iin() {
    ...
    varsIIN.br  = CheckType(Type::ISS) ? (UInt_t(2546) + ((list->utime - UInt_t(1305417600)) / UInt_t(2332800))) : 0;
...
bool Selector::process_data_iex() {
    ...
    int pt = -1;
    if ((pt < 0) && (hyc->geom_status[3] && trk->lay[0] != 0 && trk->lay[8] != 0                    )) pt = 3;
    if ((pt < 0) && (hyc->geom_status[2] &&                     trk->lay[8] != 0 && trk->lay[1] != 0)) pt = 2;
    if ((pt < 0) && (hyc->geom_status[1] && trk->lay[0] != 0                     && trk->lay[1] != 0)) pt = 1;
    ...
    varsIEX.br  = CheckType(Type::ISS) ? (UInt_t(2546) + ((list->utime - UInt_t(1305417600)) / UInt_t(2332800))) : 0;
    ...
    varsIEX.patt  = pt;
    varsIEX.optL1 = trk->lay[0];
    varsIEX.optL9 = trk->lay[8];
    varsIEX.optL2 = trk->lay[1];
    varsIEX.nhL1  = trk->ext_num_hit[0];
    varsIEX.nhL9  = trk->ext_num_hit[8];
    varsIEX.nhL2  = trk->ext_num_hit[1];
...
bool Selector::process_data_hex() {
    ...
    varsHEX.br  = CheckType(Type::ISS) ? (UInt_t(2546) + ((list->utime - UInt_t(1305417600)) / UInt_t(2332800))) : 0;
    ...
    varsHEX.patt  = pt;
    varsHEX.optL1 = trk->lay[0];
    varsHEX.optL9 = trk->lay[8];
    varsHEX.optL2 = trk->lay[1];
    varsHEX.nhL1  = trk->ext_num_hit[0];
    varsHEX.nhL9  = trk->ext_num_hit[8];
    varsHEX.nhL2  = trk->ext_num_hit[1];
...
bool Selector::process_data_hfs() {
    ...
    // Tracker-FS
    if (trk->lay[0] == 0) return false;
    if (trk->lay[8] == 0) return false;
    ...
    varsHFS.br  = CheckType(Type::ISS) ? (UInt_t(2546) + ((list->utime - UInt_t(1305417600)) / UInt_t(2332800))) : 0;
    ...
    varsHFS.optL1 = trk->lay[0];
    varsHFS.optL9 = trk->lay[8];
    varsHFS.optL2 = trk->lay[1];
    varsHFS.nhL1  = trk->ext_num_hit[0];
    varsHFS.nhL9  = trk->ext_num_hit[8];
    varsHFS.nhL2  = trk->ext_num_hit[1];
