#/bin/bash
#/afs/cern.ch/user/h/hchou/AMSProject/apflux/exe/apflux_acc
#/afs/cern.ch/user/h/hchou/AMSProject/apflux/exe/apflux_rlt
#/afs/cern.ch/user/h/hchou/AMSProject/apflux/exe/apflux_app
#/afs/cern.ch/user/h/hchou/AMSProject/apflux/exe/apflux_tme
#/afs/cern.ch/user/h/hchou/AMSProject/apflux/exe/phys_tme

/afs/cern.ch/user/h/hchou/AMSProject/apflux/exe/psphys_tme
/afs/cern.ch/user/h/hchou/AMSProject/apflux/exe/apphys_tme
/afs/cern.ch/user/h/hchou/AMSProject/apflux/exe/apflux_phy

#exe/mdst_sel -type=ISS -inpath=lst/flist.cern.iss.B1130.pass7 -gindex=633 -gsize=3
