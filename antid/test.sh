#/bin/bash
/afs/cern.ch/user/h/hchou/AMSProject/antip/exe/issprof
/afs/cern.ch/user/h/hchou/AMSProject/antip/exe/physana_l
/afs/cern.ch/user/h/hchou/AMSProject/antip/exe/physana_m
/afs/cern.ch/user/h/hchou/AMSProject/antip/exe/physana_i
/afs/cern.ch/user/h/hchou/AMSProject/antip/exe/physana_hl1
/afs/cern.ch/user/h/hchou/AMSProject/antip/exe/physana_hl9
/afs/cern.ch/user/h/hchou/AMSProject/antip/exe/physana_hfs
/afs/cern.ch/user/h/hchou/AMSProject/antip/exe/physana_all

#exe/mdst -type=ISS -inpath=lst/flist.cern.iss.B1130.pass7 -gindex=33 -gsize=3
#exe/mdst -type=MC -inpath=lst/flist.cern.mc.pr.pl1.l1.021000.B1220 -gindex=33 -gsize=5
#exe/mdst -type=MC -inpath=lst/flist.cern.mc.antipr.pl1.l1.021000.B1220 -gindex=32 -gsize=10
#exe/mdst -type=MC -inpath=lst/flist.cern.mc.pr.flux.504000.B1220 -gindex=0  -gsize=1
#exe/mdst -type=MC -inpath=lst/flist.cern.mc.pr.l19.10016000.B1220 -gindex=0  -gsize=100
#exe/mdst -type=MC -inpath=lst/flist.cern.mc.pr.l1o9.flux.2016000.B1220 -gindex=0  -gsize=100
