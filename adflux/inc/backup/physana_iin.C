...
int main(int argc, char* argv[]) {
    ...
    TH1D*  hmcpr = (TH1D*)fmcpr->Get("hI_cnt_MC");
    ...
    TH1D*  hmcap = (TH1D*)fmcap->Get("hI_cnt_MC");
    ...
    TH1D*  hmcapp = (TH1D*)fmcapp->Get("hI_cnt_MC");
    ...
    TH1D*  hmcapm = (TH1D*)fmcapm->Get("hI_cnt_MC");
    ...
    PdfEditor editor(Window(), "apflux_iin", "out");
    ...
    std::vector<Hist*> vhTllr_pr2  = Hist::ProjectAll(HistProj::kY, Hist::Head("hTRIP_llr_pr"));
    std::vector<Hist*> vhTllr_el2  = Hist::ProjectAll(HistProj::kY, Hist::Head("hTRIN_llr_el"));
...
/*
    ...
    for (int it = 1; it <= AXtme.nbin(); ++it) {
        ...
        for (int ir = 10; ir <= 20; ++ir) {
            ...
            //DataFit1D fit1D(Form("T%3dR%3d", it, ir), { (TH1D*)((*vhTllr_pr2.at(ir))()), (TH1D*)((*vhTllr_el2.at(ir))()) }, (TH1D*)((*vhRllr_neg.at(ir))()), (TH1D*)((*vhRllr_pos.at(ir))()), true);
    ...
    TFile * ofle = new TFile("out/apflux_iin.root", "RECREATE");
    ofle->cd();
