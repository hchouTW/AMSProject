{
    ...
    TF1 * feloss6 = new TF1("feloss6", "[0] * (TMath::Power( ([2]/x)*[1]*[1]+(x/[2])*[4]*[4], ([2]/x)*[1]*[1]+(x/[2])*[4]*[4] ) / TMath::Gamma( ([2]/x)*[1]*[1]+(x/[2])*[4]*[4] )) * TMath::Exp(-( (([2]/x)*[1]*[1]+(x/[2])*[4]*[4]) ) * ((x-[2])/[3] + TMath::Exp(-(x-[2])/[3])) )");
    feloss6->SetParameters(1000., 1.0, 0.0015, 0.0002, 1.0); 
    
    TF1 * feloss7 = new TF1("feloss7", "[0] * (TMath::Power( ([2]/x)^([4]*[4]*[1]*[1]/2)/[1]/[1], ([2]/x)^([4]*[4]*[1]*[1]/2)/[1]/[1] ) / TMath::Gamma( ([2]/x)^([4]*[4]*[1]*[1]/2)/[1]/[1] )) * TMath::Exp(-( (([2]/x)^([4]*[4]*[1]*[1]/2)/[1]/[1]) ) * ((x-[2])/[3] + TMath::Exp(-(x-[2])/[3])) )");
    feloss7->SetParameters(1000., 1.0, 0.0015, 0.0002, 1.0); 
