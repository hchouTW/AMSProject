{
    ...
    TF1 * f1gs = new TF1("f1gs", "[0]*TMath::Exp(-0.5*x*x/[1]/[1])");
    f1gs->SetParameters(10., 10.);
    f1gs->SetNpx(100000);

    TF1 * f2gs = new TF1("f2gs", "[0]*TMath::Exp(-0.5*x*x/[1]/[1]) + [2]*TMath::Exp(-0.5*x*x/[3]/[3])");
    f2gs->SetParameters(10., 10., 10., 30.);
    f2gs->SetNpx(100000);

    TF1 * f3gs = new TF1("f3gs", "[0]*TMath::Exp(-0.5*x*x/[1]/[1]) + [2]*TMath::Exp(-0.5*x*x/[3]/[3]) + [4]*TMath::Exp(-0.5*x*x/[5]/[5])");
    f3gs->SetParameters(10., 10., 10., 30., 10., 50.);
    f3gs->SetNpx(100000);
    
    TF1 * f4gs = new TF1("f4gs", "[0]*TMath::Exp(-0.5*x*x/[1]/[1]) + [2]*TMath::Exp(-0.5*x*x/[3]/[3]) + [4]*TMath::Exp(-0.5*x*x/[5]/[5]) + [6]*TMath::Exp(-0.5*x*x/[7]/[7])");
    f4gs->SetParameters(10., 10., 10., 30., 10., 50., 10., 70.);
    f4gs->SetNpx(100000);
    
    TF1 * f5gs = new TF1("f5gs", "[0]*TMath::Exp(-0.5*x*x/[1]/[1]) + [2]*TMath::Exp(-0.5*x*x/[3]/[3]) + [4]*TMath::Exp(-0.5*x*x/[5]/[5]) + [6]*TMath::Exp(-0.5*x*x/[7]/[7]) + [8]*TMath::Exp(-0.5*x*x/[9]/[9])");
