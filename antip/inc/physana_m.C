...
int main(int argc, char* argv[]) {
    ...
    TH1D*  hmcpr = (TH1D*)fmcpr->Get("hM_MC_cnt");
    TH1D*  hTmcpr = (TH1D*)fmcpr->Get("hTM_MC_cnt");
    ...
    TH1D*  hmcap = (TH1D*)fmcap->Get("hM_MC_cnt");
    TH1D*  hTmcap = (TH1D*)fmcap->Get("hTM_MC_cnt");
    ...
    PdfEditor editor(Window(), "antip_m", "out");
...
/*
    ...
    TFile * ofle = new TFile("out/antip_m.root", "RECREATE");
    ofle->cd();
