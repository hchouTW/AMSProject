...
int main(int argc, char* argv[]) {
    ...
    TH1D*  hmcpr = (TH1D*)fmcpr->Get("hHfs_cnt_MC_FLUX10");
    ...
    TH1D*  hmcap = (TH1D*)fmcap->Get("hHfs_cnt_MC_FLUX10");
    ...
    //Hist* hcc_cc = Hist::New("hHNfs_lchiy_lrvar_cc", (TH1*)TFile::Open(Form("/eos/ams/user/h/hchou/AMSData/subj/antip/19Nov03/mcprflux%s/YiMdst.root", subv.c_str()))->Get("hHNfs_lchiy_lrvar_MC_FLUX27"));
    Hist* hcc_cc = Hist::New("hHNfs_lchiy_lrvar_cc", (TH1*)TFile::Open(Form("/eos/ams/user/h/hchou/AMSData/subj/antip/19Nov03/mcprL1o9flux_%s/YiMdst.root", subv.c_str()))->Get("hHNfs_lchiy_lrvar_MC_FLUX27"));
