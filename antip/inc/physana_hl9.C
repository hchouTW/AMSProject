...
int main(int argc, char* argv[]) {
    ...
    TH1D*  hmcpr = (TH1D*)fmcpr->Get("hHl9_MC_cnt");
    ...
    TH1D*  hmcap = (TH1D*)fmcap->Get("hHl9_MC_cnt");
    ...
    Hist* hcc_cc = Hist::New("hHNl9_lchiy_lrvar_cc", (TH1*)TFile::Open(Form("/eos/ams/user/h/hchou/AMSData/subj/antip/19Nov03/mcprflux%s/YiMdst.root", subv.c_str()))->Get("hHNl9_lchiy_lrvar"));
