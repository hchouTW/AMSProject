...
void stdfmt(TMultiGraph* mg) {
    ...
    mg->GetHistogram()->GetXaxis()->SetTitleSize(21);
    ...
    mg->GetHistogram()->GetYaxis()->SetTitleSize(21);
...
int main(int argc, char* argv[]) {
    ...
    if (argc != 4) return 0;
    std::string dir_pr  = Form("/afs/cern.ch/user/h/hchou/AMSProject/trsys2/%s", argv[1]);
    std::string dir_he  = Form("/afs/cern.ch/user/h/hchou/AMSProject/trsys2/%s", argv[2]);
    std::string dir_iss = Form("/afs/cern.ch/user/h/hchou/AMSProject/trsys2/%s", argv[3]);

    PdfEditor editor(Window(), "fit_merge", "out", PdfEditor::Type::kEPS, PdfEditor::Mode::kMergeAndAlone);

    if (true) {
        TFile* file_pr = TFile::Open(Form("%s/fit_eloss.root", dir_pr.c_str()));
        TGraphErrors* gr_pr_MCmen = (TGraphErrors*) file_pr->Get("gr_hMCmen");
        TGraphErrors* gr_pr_LLmen = (TGraphErrors*) file_pr->Get("gr_hLLmen");
        TGraphErrors* gr_pr_BBmen = (TGraphErrors*) file_pr->Get("gr_hBBmen");
        ...
        style(gr_pr_LLmen, Line(kGreen+1),  Marker(kGreen+1,  MarkerStyle(MarkerShape::kCross,   MarkerType::kFull)));
        style(gr_pr_BBmen, Line(kYellow+1), Marker(kYellow+1, MarkerStyle(MarkerShape::kCross,   MarkerType::kFull)));
        ...
        TGraphErrors* gr_he_LLmen = (TGraphErrors*) file_he->Get("gr_hLLmen");
        TGraphErrors* gr_he_BBmen = (TGraphErrors*) file_he->Get("gr_hBBmen");
        ...
        style(gr_he_LLmen, Line(kGreen+1),  Marker(kGreen+1,  MarkerStyle(MarkerShape::kCross,   MarkerType::kOpen)));
        style(gr_he_BBmen, Line(kYellow+1), Marker(kYellow+1, MarkerStyle(MarkerShape::kCross,   MarkerType::kOpen)));
        style(gr_he_SMmen, Line(kRed),      Marker(kRed,      MarkerStyle(MarkerShape::kDiamond, MarkerType::kOpen)));
        
        TMultiGraph* mg_pr_men = new TMultiGraph();
        mg_pr_men->Add(gr_pr_LLmen);
        mg_pr_men->Add(gr_pr_BBmen);
        mg_pr_men->Add(gr_pr_SMmen);
        
        TMultiGraph* mg_pr_men_comp = new TMultiGraph();
        mg_pr_men_comp->Add(gr_pr_MCmen);
        mg_pr_men_comp->Add(gr_pr_SMmen);
        
        TMultiGraph* mg_he_men = new TMultiGraph();
        mg_he_men->Add(gr_he_LLmen);
        mg_he_men->Add(gr_he_BBmen);
        mg_he_men->Add(gr_he_SMmen);
        
        TMultiGraph* mg_he_men_comp = new TMultiGraph();
        mg_he_men_comp->Add(gr_he_MCmen);
        mg_he_men_comp->Add(gr_he_SMmen);
        
        editor.create("", 1, 2);

        TVirtualPad* pad_pr1 = editor.set(1, PadWindow(0.0, 1.0, 0.4, 1.0), PadAxis(1));
        pad_pr1->SetTopMargin(0.1);
        pad_pr1->SetBottomMargin(0.015);
        mg_pr_men->Draw("ap");
        mg_pr_men->GetHistogram()->GetXaxis()->CenterTitle();
        mg_pr_men->GetHistogram()->SetLineColor(0);
        mg_pr_men->GetHistogram()->SetMarkerColor(0);
        mg_pr_men->GetHistogram()->GetXaxis()->SetTitle("1/(#gamma#beta)");
        mg_pr_men->GetHistogram()->GetYaxis()->SetTitle("Energy Loss [MeV]");
        stdfmt(mg_pr_men);
        mg_pr_men->GetHistogram()->GetXaxis()->SetTitleSize(0.0);
        mg_pr_men->GetHistogram()->GetXaxis()->SetLabelSize(0.0);
        mg_pr_men->Draw("ap");
        Legend leg_pr_men("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.55, 0.85));
        leg_pr_men()->AddEntry((TObject*)0, "Simulation: Proton", "");
        leg_pr_men()->AddEntry(gr_pr_LLmen, "Landau-Vavilov-Bichsel", "lp");
        leg_pr_men()->AddEntry(gr_pr_BBmen, "Bethe", "lp");
        leg_pr_men()->AddEntry(gr_pr_SMmen, "Mixture", "lp");
        leg_pr_men.draw();
        
        TVirtualPad* pad_pr2 = editor.set(2, PadWindow(0.0, 1.0, 0.0, 0.4), PadAxis(1));
        pad_pr2->SetTopMargin(0.015);
        pad_pr2->SetBottomMargin(0.25);
        //pad_pr2->SetGridx();
        mg_pr_men_comp->Draw("ap");
        mg_pr_men_comp->GetHistogram()->GetXaxis()->CenterTitle();
        mg_pr_men_comp->GetHistogram()->SetLineColor(0);
        mg_pr_men_comp->GetHistogram()->SetMarkerColor(0);
        mg_pr_men_comp->GetHistogram()->GetXaxis()->SetTitle("1/(#gamma#beta)");
        mg_pr_men_comp->GetHistogram()->GetYaxis()->SetTitle("Energy Loss [MeV]");
        stdfmt(mg_pr_men_comp);
        mg_pr_men_comp->Draw("ap");
        Legend leg_pr_men_comp("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.75, 0.95));
        leg_pr_men_comp()->AddEntry(gr_pr_MCmen, "GEANT4", "lp");
        leg_pr_men_comp()->AddEntry(gr_pr_SMmen, "Mixture", "lp");
        leg_pr_men_comp.draw();
        editor.save();

        editor.create("", 1, 2);

        TVirtualPad* pad_he1 = editor.set(1, PadWindow(0.0, 1.0, 0.4, 1.0), PadAxis(1));
        pad_he1->SetTopMargin(0.1);
        pad_he1->SetBottomMargin(0.015);
        mg_he_men->Draw("ap");
        mg_he_men->GetHistogram()->GetXaxis()->CenterTitle();
        mg_he_men->GetHistogram()->SetLineColor(0);
        mg_he_men->GetHistogram()->SetMarkerColor(0);
        mg_he_men->GetHistogram()->GetXaxis()->SetTitle("1/(#gamma#beta)");
        mg_he_men->GetHistogram()->GetYaxis()->SetTitle("Energy Loss [MeV]");
        stdfmt(mg_he_men);
        mg_he_men->GetHistogram()->GetXaxis()->SetTitleSize(0.0);
        mg_he_men->GetHistogram()->GetXaxis()->SetLabelSize(0.0);
        mg_he_men->Draw("ap");
        Legend leg_he_men("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.55, 0.85));
        leg_he_men()->AddEntry((TObject*)0, "Simulation: Helium-4", "");
        leg_he_men()->AddEntry(gr_pr_LLmen, "Landau-Vavilov-Bichsel", "lp");
        leg_he_men()->AddEntry(gr_pr_BBmen, "Bethe", "lp");
        leg_he_men()->AddEntry(gr_pr_SMmen, "Mixture", "lp");
        leg_he_men.draw();
        
        TVirtualPad* pad_he2 = editor.set(2, PadWindow(0.0, 1.0, 0.0, 0.4), PadAxis(1));
        pad_he2->SetTopMargin(0.015);
        pad_he2->SetBottomMargin(0.25);
        //pad_he2->SetGridx();
        mg_he_men_comp->Draw("ap");
        mg_he_men_comp->GetHistogram()->GetXaxis()->CenterTitle();
        mg_he_men_comp->GetHistogram()->SetLineColor(0);
        mg_he_men_comp->GetHistogram()->SetMarkerColor(0);
        mg_he_men_comp->GetHistogram()->GetXaxis()->SetTitle("1/(#gamma#beta)");
        mg_he_men_comp->GetHistogram()->GetYaxis()->SetTitle("Energy Loss [MeV]");
        stdfmt(mg_he_men_comp);
        mg_he_men_comp->Draw("ap");
        Legend leg_he_men_comp("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.75, 0.95));
        leg_he_men_comp()->AddEntry(gr_pr_MCmen, "GEANT4", "lp");
        leg_he_men_comp()->AddEntry(gr_pr_SMmen, "Mixture", "lp");
        leg_he_men_comp.draw();
        editor.save();
    ...
    if (true) {
        ...
        mg_men->Draw("ap");
        Legend leg_men("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.65, 0.90));
        leg_men()->AddEntry((TObject*)0, "Simulation", "");
        leg_men()->AddEntry(gr_pr_MCmen, "Proton: GEANT4", "lp");
        leg_men()->AddEntry(gr_pr_SMmen, "Proton: FPM", "lp");
        leg_men()->AddEntry(gr_he_MCmen, "Helium-4: GEANT4", "lp");
        leg_men()->AddEntry(gr_he_SMmen, "Helium-4: FPM", "lp");
        leg_men.draw();
        editor.save();
    ...
    if (true) {
        ...
        TVirtualPad* pad1 = editor.set(1, PadWindow(0.0, 1.0, 0.4, 1.0), PadAxis(1));
        ...
        mg_rso->Draw("ap");
        Legend leg_rso("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.50, 0.85));
        leg_rso()->AddEntry((TObject*)0, "Simulation", "");
        leg_rso()->AddEntry(gr_pr_MCrso, "Proton: GEANT4", "lp");
        leg_rso()->AddEntry(gr_pr_SMrso, "Proton: FPM", "lp");
        leg_rso()->AddEntry(gr_he_MCrso, "Helium-4: GEANT4", "lp");
        leg_rso()->AddEntry(gr_he_SMrso, "Helium-4: FPM", "lp");
        leg_rso.draw();
        
        TVirtualPad* pad2 = editor.set(2, PadWindow(0.0, 1.0, 0.0, 0.4), PadAxis(1));
        ...
        stdfmt(mg_relrso);
        mg_relrso->Draw("ap");
        Legend leg_relrso("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.75, 0.95));
    ...
    if (true) {
        ...
        mg_men->Draw("ap");
        Legend leg_men("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.50, 0.85));
        leg_men()->AddEntry((TObject*)0, "Simulation", "");
        leg_men()->AddEntry(gr_pr_MCmen, "Proton: GEANT4", "lp");
        leg_men()->AddEntry(gr_pr_SMmen, "Proton: FPM", "lp");
        leg_men()->AddEntry(gr_he_MCmen, "Helium-4: GEANT4", "lp");
        ...
        stdfmt(mg_relmen);
        mg_relmen->Draw("ap");
        Legend leg_relmen("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.75, 0.95));
    ...
    if (true) {
        ...
        editor.create();
        editor.cd(0, PadAxis(0));
        mg_men->Draw("ap");
        mg_men->GetHistogram()->GetXaxis()->CenterTitle();
        mg_men->GetHistogram()->SetLineColor(0);
        mg_men->GetHistogram()->SetMarkerColor(0);
        mg_men->GetHistogram()->GetXaxis()->SetTitle("Velocity (#beta)");
        mg_men->GetHistogram()->GetYaxis()->SetTitle("Bias of #beta [%]");
        mg_men->GetHistogram()->SetMinimum(-15.0);
        mg_men->GetHistogram()->SetMaximum(  3.0);
        mg_men->Draw("ap");
        Legend leg_men("", TextStyle(kBlack, 20, 43), PadWindow(0.50, 0.85, 0.20, 0.45));
        leg_men()->AddEntry((TObject*)0, "Inner Tracker & TOF", "");
    ...
    if (true) {
        ...
        TVirtualPad* pad1 = editor.set(1, PadWindow(0.0, 1.0, 0.4, 1.0), PadAxis(0));
        pad1->SetTopMargin(0.1);
        pad1->SetBottomMargin(0.015);
        //pad1->SetGridx();
        mg_rso->Draw("ap");
        ...
        mg_rso->GetHistogram()->SetLineColor(0);
        mg_rso->GetHistogram()->SetMarkerColor(0);
        mg_rso->GetHistogram()->GetXaxis()->SetTitle("Velocity (#beta)");
        ...
        mg_rso->Draw("ap");
        Legend leg_rso("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.50, 0.85));
        leg_rso()->AddEntry((TObject*)0, "Inner Tracker & TOF", "");
        ...
        TVirtualPad* pad2 = editor.set(2, PadWindow(0.0, 1.0, 0.0, 0.4), PadAxis(0));
        pad2->SetTopMargin(0.015);
        pad2->SetBottomMargin(0.25);
        //pad2->SetGridx();
        mg_relrso->Draw("ap");
        ...
        mg_relrso->GetHistogram()->SetLineColor(0);
        mg_relrso->GetHistogram()->SetMarkerColor(0);
        mg_relrso->GetHistogram()->GetXaxis()->SetTitle("Velocity (#beta)");
        mg_relrso->GetHistogram()->GetYaxis()->SetTitle("Ratio");
    ...
    if (true) {
        ...
        mg_men->Draw("ap");
        Legend leg_men("", TextStyle(kBlack, 20, 43), PadWindow(0.55, 0.85, 0.20, 0.45));
    ...
    if (true) {
        ...
        mg_men->GetHistogram()->SetMarkerColor(0);
        mg_men->GetHistogram()->GetXaxis()->SetTitle("Velocity (#beta)");
        mg_men->GetHistogram()->GetYaxis()->SetTitle("Mean of M^{2}/Z^{2} [(GV/c^{2})^{2}]");
        mg_men->GetHistogram()->SetMinimum(0.0);
        mg_men->GetHistogram()->SetMaximum(4.0);
        mg_men->Draw("ap");
        Legend leg_men("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.40, 0.60));
        leg_men()->AddEntry((TObject*)0, "Inner Tracker & TOF", "");
        leg_men()->AddEntry(gr_pr_OFmen, "Proton: Official fitting", "lp");
        leg_men()->AddEntry(gr_pr_HCmen, "Proton: FPM fitting", "lp");
        leg_men()->AddEntry(gr_he_OFmen, "Helium-4: Official fitting", "lp");
    ...
    if (true) {
        ...
        mg_men->GetHistogram()->SetMaximum(4.0);
        mg_men->Draw("ap");
        Legend leg_men("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.28, 0.62));
        leg_men()->AddEntry((TObject*)0, "Inner Tracker & TOF", "");
        leg_men()->AddEntry(gr_pr_OFmen, "Proton: Official fitting", "lp");
        leg_men()->AddEntry(gr_pr_HCmen, "Proton: FPM fitting", "lp");
        leg_men()->AddEntry(gr_he_OFmen, "Helium-4: Official fitting", "lp");
        ...
        mg_relmen->GetHistogram()->SetLineColor(0);
        mg_relmen->GetHistogram()->SetMarkerColor(0);
        mg_relmen->GetHistogram()->GetXaxis()->SetTitle("Velocity (#beta)");
        mg_relmen->GetHistogram()->GetYaxis()->SetTitle("Ratio");
        mg_relmen->GetHistogram()->SetMinimum(0.645);
        mg_relmen->GetHistogram()->SetMaximum(1.405);
        stdfmt(mg_relmen);
        mg_relmen->Draw("ap");
        Legend leg_relmen("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.60, 0.95));
    ...
    if (true) {
        ...
        mg_rso->GetHistogram()->SetMarkerColor(0);
        mg_rso->GetHistogram()->GetXaxis()->SetTitle("Velocity (#beta)");
        mg_rso->GetHistogram()->GetYaxis()->SetTitle("Resolution of M^{2}/Z^{2} [(GV/c^{2})^{2}]");
        stdfmt(mg_rso);
        mg_rso->GetHistogram()->GetXaxis()->SetTitleSize(0.0);
        mg_rso->GetHistogram()->GetXaxis()->SetLabelSize(0.0);
        mg_rso->GetHistogram()->SetMinimum(0.0);
    ...
    if (true) {
        ...
        mg_men->Draw("ap");
        Legend leg_men("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.40, 0.60));
        leg_men()->AddEntry((TObject*)0, "Inner Tracker & RICH", "");
        leg_men()->AddEntry(gr_pr_OFmen, "Proton: Official fitting", "lp");
        leg_men()->AddEntry(gr_pr_HCmen, "Proton: FPM fitting", "lp");
        leg_men()->AddEntry(gr_he_OFmen, "Helium-4: Official fitting", "lp");
        leg_men()->AddEntry(gr_he_HCmen, "Helium-4: FPM fitting", "lp");
    ...
    if (true) {
        ...
        stdfmt(mg_relmen);
        mg_relmen->Draw("ap");
        Legend leg_relmen("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.30, 0.75));
        leg_relmen()->AddEntry(gr_pr_OFrelmen, "Proton: Official / Theory", "lp");
        leg_relmen()->AddEntry(gr_pr_HCrelmen, "Proton: FPM / Theory", "lp");
        leg_relmen()->AddEntry(gr_he_OFrelmen, "Helium-4: Official / Theory", "lp");
        leg_relmen()->AddEntry(gr_he_HCrelmen, "Helium-4: FPM / Theory", "lp");
    ...
    if (true) {
        ...
        mg_rso->Draw("ap");
        Legend leg_rso("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.50, 0.85));
        leg_rso()->AddEntry((TObject*)0, "Inner Tracker & RICH", "");
        leg_rso()->AddEntry(gr_pr_OFrso, "Proton: Official fitting", "lp");
        leg_rso()->AddEntry(gr_pr_HCrso, "Proton: FPM fitting", "lp");
        leg_rso()->AddEntry(gr_he_OFrso, "Helium-4: Official fitting", "lp");
        leg_rso()->AddEntry(gr_he_HCrso, "Helium-4: FPM fitting", "lp");
    ...
    std::array<std::string, 4> trpts_name({ "Inner Tracker", "Inner+L1 Tracker", "Inner+L9 Tracker", "FullSpan Tracker" });
    std::array<int, 4> trpts_mdr_pr_ck({ 274,  664,  873, 1928 });
    std::array<int, 4> trpts_mdr_pr_hc({ 297,  729,  953, 2030 });
    ...
    if (true) {
        ...
        mg_men->GetHistogram()->SetLineColor(0);
        mg_men->GetHistogram()->SetMarkerColor(0);
        mg_men->GetHistogram()->GetXaxis()->SetTitle("Rigidity (R) [GV/c]");
        mg_men->GetHistogram()->GetYaxis()->SetTitle("Bias of R [%]");
        mg_men->GetHistogram()->SetMinimum(-3.0);
        mg_men->GetHistogram()->SetMaximum( 25.0);
        mg_men->Draw("ap");
        Legend leg_men("", TextStyle(kBlack, 20, 43), PadWindow(0.55, 0.80, 0.60, 0.85));
    ...
    if (true) {
        ...
        mg_rso->GetHistogram()->SetLineColor(0);
        mg_rso->GetHistogram()->SetMarkerColor(0);
        mg_rso->GetHistogram()->GetXaxis()->SetTitle("Rigidity (R) [GV/c]");
        mg_rso->GetHistogram()->GetYaxis()->SetTitle("Resolution of R [%]");
        stdfmt(mg_rso);
        mg_rso->GetHistogram()->GetXaxis()->SetTitleSize(0.0);
        mg_rso->GetHistogram()->GetXaxis()->SetLabelSize(0.0);
        mg_rso->GetHistogram()->SetMinimum(0.0);
        //mg_rso->GetHistogram()->SetMaximum(2.5);
        mg_rso->Draw("ap");
        Legend leg_rso("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.60, 0.50, 0.85));
        ...
        mg_relrso->GetHistogram()->SetLineColor(0);
        mg_relrso->GetHistogram()->SetMarkerColor(0);
        mg_relrso->GetHistogram()->GetXaxis()->SetTitle("Rigidity (R) [GV/c]");
        mg_relrso->GetHistogram()->GetYaxis()->SetTitle("Ratio");
        mg_relrso->GetHistogram()->SetMinimum(0.3);
        mg_relrso->GetHistogram()->SetMaximum(1.01);
        stdfmt(mg_relrso);
        mg_relrso->Draw("ap");
        Legend leg_relrso("", TextStyle(kBlack, 20, 43), PadWindow(0.60, 0.85, 0.30, 0.55));
        leg_relrso()->AddEntry(gr_pr_relrso, "Proton: FPM / Official", "lp");
        leg_relrso()->AddEntry(gr_he_relrso, "Helium-4: FPM / Official", "lp");
        leg_relrso.draw();
    ...
    if (true) {
        ...
        mg_men->GetHistogram()->SetMaximum( 25.0);
        mg_men->Draw("ap");
        Legend leg_men("", TextStyle(kBlack, 20, 43), PadWindow(0.50, 0.80, 0.55, 0.85));
        leg_men()->AddEntry((TObject*)0, "Inner Tracker & TOF", "");
        leg_men()->AddEntry(gr_pr_OFmen, "Proton: Official fitting", "lp");
    ...
    if (true) {
        ...
        mg_rso->Draw("ap");
        Legend leg_rso("", TextStyle(kBlack, 20, 43), PadWindow(0.50, 0.80, 0.40, 0.85));
        leg_rso()->AddEntry((TObject*)0, "Inner Tracker & TOF", "");
        leg_rso()->AddEntry(gr_pr_OFrso, "Proton: Official fitting", "lp");
        ...
        stdfmt(mg_relrso);
        mg_relrso->Draw("ap");
        Legend leg_relrso("", TextStyle(kBlack, 20, 43), PadWindow(0.55, 0.80, 0.30, 0.70));
    ...
    if (true) {
        ...
        mg_rso->GetHistogram()->SetMaximum(30.0);
        mg_rso->Draw("ap");
        Legend leg_rso("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.45, 0.40, 0.85));
        leg_rso()->AddEntry((TObject*)0, "Inner Tracker & RICH", "");
        leg_rso()->AddEntry(gr_pr_OFrso, "Proton: Official fitting", "lp");
        leg_rso()->AddEntry(gr_pr_GMrso, "Proton: FPM rigidity fitting", "lp");
        leg_rso()->AddEntry(gr_pr_PHrso, "Proton: FPM track fitting", "lp");
        ...
        stdfmt(mg_relrso);
        mg_relrso->Draw("ap");
        Legend leg_relrso("", TextStyle(kBlack, 20, 43), PadWindow(0.55, 0.85, 0.30, 0.60));
        leg_relrso()->AddEntry(gr_pr_GMrelrso, "Proton: FPM rigidity / Official", "lp");
        leg_relrso()->AddEntry(gr_pr_PHrelrso, "Proton: FPM track / Official", "lp");
        leg_relrso()->AddEntry(gr_he_GMrelrso, "Helium-4: FPM rigidity / Official", "lp");
        leg_relrso()->AddEntry(gr_he_PHrelrso, "Helium-4: FPM track / Official", "lp");
    ...
    if (true) {
        TFile* file_iss = TFile::Open(Form("%s/issprof.root", dir_iss.c_str()));
        Hist* hCKrvar = Hist::New((TH1D*)file_iss->Get("hPROF_CK_rvar_cut"));
        Hist* hHCrvar = Hist::New((TH1D*)file_iss->Get("hPROF_HC_rvar_cut"));

        hCKrvar->style(Line(kBlue, 0, 2.0), Marker(kBlue, MarkerStyle(MarkerShape::kCircle,  MarkerType::kFull)));
        hHCrvar->style(Line(kRed,  0, 2.0), Marker(kRed,  MarkerStyle(MarkerShape::kDiamond, MarkerType::kFull)));
        THStack* hrvar = Hist::Collect("hrvar", HistList({ hCKrvar, hHCrvar }));
        
        editor.create();
        editor.cd(0);
        hrvar->Draw("nostack hist");
        hrvar->GetHistogram()->GetXaxis()->SetRangeUser(-1.5, 1.5);
        hrvar->GetHistogram()->GetXaxis()->CenterTitle();
        hrvar->GetHistogram()->SetLineColor(0);
        hrvar->GetHistogram()->SetMarkerColor(0);
        hrvar->GetHistogram()->GetXaxis()->SetTitle("Scaled(1/R_{L9}-1/R_{L1})");
        hrvar->GetHistogram()->GetYaxis()->SetTitle("Probability");
        hrvar->Draw("nostack hist");
        hrvar->Draw("nostack p same");
        Legend leg_rvar("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.75, 0.90));
        leg_rvar()->AddEntry((TObject*)0, "|Z|=1 & |R| > 100 [GV/c]", "");
        leg_rvar()->AddEntry((*hCKrvar)(), Form("Official fitting (#sigma = %6.3f)", 0.2823), "lp");
        leg_rvar()->AddEntry((*hHCrvar)(), Form("FPM fitting (#sigma = %6.3f)", 0.2550), "lp");
        leg_rvar.draw();
        editor.save();

        Hist* hCKmass = Hist::New((TH1D*)file_iss->Get("hPROF_CK_mass_ISS"));
        Hist* hHCmass = Hist::New((TH1D*)file_iss->Get("hPROF_HC_mass_ISS"));
        
        hCKmass->style(Line(kBlue, 0, 2.0), Marker(kBlue, MarkerStyle(MarkerShape::kCircle,  MarkerType::kFull)));
        hHCmass->style(Line(kRed,  0, 2.0), Marker(kRed,  MarkerStyle(MarkerShape::kDiamond, MarkerType::kFull)));
        THStack* hmass = Hist::Collect("hmass", HistList({ hCKmass, hHCmass }));
        
        editor.create();
        editor.cd(0, PadAxis(0, 1));
        hmass->Draw("nostack hist");
        hmass->SetMinimum(0.1);
        hmass->GetHistogram()->GetXaxis()->CenterTitle();
        hmass->GetHistogram()->SetLineColor(0);
        hmass->GetHistogram()->SetMarkerColor(0);
        hmass->GetHistogram()->GetXaxis()->SetTitle("Mass/Charge (M/Z) [GV/c^{2}]");
        hmass->GetHistogram()->GetYaxis()->SetTitle("Events / Bin");
        hmass->Draw("nostack hist");
        Legend leg_mass("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.70, 0.90));
        leg_mass()->AddEntry((TObject*)0, "Data (05/24/2011 ~ 12/14/2018)", "");
        leg_mass()->AddEntry((TObject*)0, "|Z|=1 & (0.50 < #beta < 0.80)", "");
        leg_mass()->AddEntry((*hCKmass)(), "Official fitting", "l");
        leg_mass()->AddEntry((*hHCmass)(), "FPM fitting", "l");
        leg_mass.draw();
        TextDraw("D^{+}"  , TextStyle(kBlack, 0.05), TextAlign(0.80, 0.80));
        TextDraw("p"      , TextStyle(kBlack, 0.05), TextAlign(0.67, 0.80));
        TextDraw("#bar{p}", TextStyle(kBlack, 0.05), TextAlign(0.40, 0.48));
        TextDraw("K^{-}"  , TextStyle(kBlack, 0.05), TextAlign(0.46, 0.53));
        TextDraw("#pi^{+}", TextStyle(kBlack, 0.05), TextAlign(0.56, 0.77));
        TextDraw("#pi^{-}", TextStyle(kBlack, 0.05), TextAlign(0.51, 0.77));
        editor.save();

        Hist* hHCmass_d   = Hist::New((TH1D*)file_iss->Get("TEMP000117_RVAR_sqrm2__hPROF_HC_mass_d_pure"));
        Hist* hHCmass_pr  = Hist::New((TH1D*)file_iss->Get("TEMP000117_RVAR_sqrm2__hPROF_HC_mass_pr_pure"));
        Hist* hHCmass_ap  = Hist::New((TH1D*)file_iss->Get("TEMP000117_RVAR_sqrm2__hPROF_HC_mass_ap_pure"));
        Hist* hHCmass_kp  = Hist::New((TH1D*)file_iss->Get("TEMP000117_RVAR_sqrm2__hPROF_HC_mass_kp"));
        Hist* hHCmass_kn  = Hist::New((TH1D*)file_iss->Get("TEMP000117_RVAR_sqrm2__hPROF_HC_mass_kn"));
        Hist* hHCmass_pip = Hist::New((TH1D*)file_iss->Get("TEMP000117_RVAR_sqrm2__hPROF_HC_mass_pip"));
        Hist* hHCmass_pin = Hist::New((TH1D*)file_iss->Get("TEMP000117_RVAR_sqrm2__hPROF_HC_mass_pin"));
        
        hHCmass_d  ->style(Line(kMagenta+1, 0, 2.0), Marker(kMagenta+1, MarkerStyle(MarkerShape::kSquare,       MarkerType::kFull)));
        hHCmass_pr ->style(Line(kBlue,      0, 2.0), Marker(kBlue,      MarkerStyle(MarkerShape::kCross,        MarkerType::kFull)));
        hHCmass_ap ->style(Line(kBlue,      0, 2.0), Marker(kBlue,      MarkerStyle(MarkerShape::kCross,        MarkerType::kOpen)));
        hHCmass_kp ->style(Line(kYellow+1,  0, 2.0), Marker(kYellow+1,  MarkerStyle(MarkerShape::kTriangleUp,   MarkerType::kFull)));
        hHCmass_kn ->style(Line(kYellow+1,  0, 2.0), Marker(kYellow+1,  MarkerStyle(MarkerShape::kTriangleUp,   MarkerType::kOpen)));
        hHCmass_pip->style(Line(kGreen+1,   0, 2.0), Marker(kGreen+1,   MarkerStyle(MarkerShape::kTriangleDown, MarkerType::kFull)));
        hHCmass_pin->style(Line(kGreen+1,   0, 2.0), Marker(kGreen+1,   MarkerStyle(MarkerShape::kTriangleDown, MarkerType::kOpen)));
        THStack* hFITmass = Hist::Collect("hFITmass", HistList({ hHCmass_d, hHCmass_pr, hHCmass_ap, hHCmass_kp, hHCmass_kn, hHCmass_pip, hHCmass_pin }));
        
        editor.create();
        editor.cd(0, PadAxis(0, 1));
        (*hHCmass)()->SetMinimum(0.1);
        (*hHCmass)()->GetXaxis()->CenterTitle();
        (*hHCmass)()->GetXaxis()->SetTitle("Mass/Charge (M/Z) [GV/c^{2}]");
        (*hHCmass)()->GetYaxis()->SetTitle("Events / Bin");
        (*hHCmass)()->Draw("hist");
        hFITmass->Draw("nostack hist same");
        //hHCmass->draw("hist same");
        hHCmass->draw("pe same");
        Legend leg_FITmass("", TextStyle(kBlack, 20, 43), PadWindow(0.15, 0.40, 0.55, 0.90));
        leg_FITmass()->AddEntry((TObject*)0, "Data (05/24/2011 ~ 12/14/2018)", "");
        leg_FITmass()->AddEntry((TObject*)0, "|Z|=1 & (0.50 < #beta < 0.80)", "");
        leg_FITmass()->AddEntry((*hHCmass)(), "Data", "lp");
        leg_FITmass()->AddEntry((*hHCmass_d  )(), "MC D^{+}", "l");
        leg_FITmass()->AddEntry((*hHCmass_pr )(), "MC p", "l");
        leg_FITmass()->AddEntry((*hHCmass_ap )(), "MC #bar{p}", "l");
        leg_FITmass()->AddEntry((*hHCmass_kp )(), "MC K^{+}", "l");
        leg_FITmass()->AddEntry((*hHCmass_kn )(), "MC K^{-}", "l");
        leg_FITmass()->AddEntry((*hHCmass_pip)(), "MC #pi^{+}", "l");
        leg_FITmass()->AddEntry((*hHCmass_pin)(), "MC #pi^{-}", "l");
        leg_FITmass.draw();
        TextDraw("D^{+}"   , TextStyle(kMagenta+1, 0.05), TextAlign(0.80, 0.80));
        TextDraw("p"       , TextStyle(kBlue,      0.05), TextAlign(0.67, 0.80));
        TextDraw("#bar{p}" , TextStyle(kBlue,      0.05), TextAlign(0.40, 0.48));
        TextDraw("K^{+}"   , TextStyle(kYellow+1,  0.05), TextAlign(0.58, 0.68));
        TextDraw("K^{-}"   , TextStyle(kYellow+1,  0.05), TextAlign(0.46, 0.53));
        TextDraw("#pi^{+}" , TextStyle(kGreen+1,   0.05), TextAlign(0.56, 0.73));
        TextDraw("#pi^{-}" , TextStyle(kGreen+1,   0.05), TextAlign(0.51, 0.73));
        editor.save();

        Axis AXmz("|Mass/Charge| (|M/Z|) [GV/c^{2}]", 300, 0.0, 3.0);
        Hist* hCKmz    = Hist::New("hCKmz"   , HistAxis(AXmz));
        Hist* hHCmz    = Hist::New("hHCmz"   , HistAxis(AXmz));
        Hist* hHCmz_d  = Hist::New("hHCmz_d" , HistAxis(AXmz));
        Hist* hHCmz_p  = Hist::New("hHCmz_p" , HistAxis(AXmz));
        Hist* hHCmz_k  = Hist::New("hHCmz_k" , HistAxis(AXmz));
        Hist* hHCmz_pi = Hist::New("hHCmz_pi", HistAxis(AXmz));

        for (int ib = 1; ib <= AXmz.nbin(); ++ib) {
            (*hCKmz)()->SetBinContent(ib, (*hCKmass)()->GetBinContent(AXmz.nbin() + ib) + (*hCKmass)()->GetBinContent(AXmz.nbin() - ib + 1));
            (*hCKmz)()->SetBinError  (ib, std::hypot((*hCKmass)()->GetBinError  (AXmz.nbin() + ib), (*hCKmass)()->GetBinError  (AXmz.nbin() - ib + 1)));
            (*hHCmz)()->SetBinContent(ib, (*hHCmass)()->GetBinContent(AXmz.nbin() + ib) + (*hHCmass)()->GetBinContent(AXmz.nbin() - ib + 1));
            (*hHCmz)()->SetBinError  (ib, std::hypot((*hHCmass)()->GetBinError  (AXmz.nbin() + ib), (*hHCmass)()->GetBinError  (AXmz.nbin() - ib + 1)));
            
            (*hHCmz_d )()->SetBinContent(ib, (*hHCmass_d  )()->GetBinContent(AXmz.nbin() + ib));
            (*hHCmz_d )()->SetBinError  (ib, (*hHCmass_d  )()->GetBinError  (AXmz.nbin() + ib));
            (*hHCmz_p )()->SetBinContent(ib, (*hHCmass_pr )()->GetBinContent(AXmz.nbin() + ib) + (*hHCmass_ap )()->GetBinContent(AXmz.nbin() - ib + 1));
            (*hHCmz_p )()->SetBinError  (ib, std::hypot((*hHCmass_pr )()->GetBinError  (AXmz.nbin() + ib), (*hHCmass_ap )()->GetBinError  (AXmz.nbin() - ib + 1)));
            (*hHCmz_k )()->SetBinContent(ib, (*hHCmass_kp )()->GetBinContent(AXmz.nbin() + ib) + (*hHCmass_kn )()->GetBinContent(AXmz.nbin() - ib + 1));
            (*hHCmz_k )()->SetBinError  (ib, std::hypot((*hHCmass_kp )()->GetBinError  (AXmz.nbin() + ib), (*hHCmass_kn )()->GetBinError  (AXmz.nbin() - ib + 1)));
            (*hHCmz_pi)()->SetBinContent(ib, (*hHCmass_pip)()->GetBinContent(AXmz.nbin() + ib) + (*hHCmass_pin)()->GetBinContent(AXmz.nbin() - ib + 1));
            (*hHCmz_pi)()->SetBinError  (ib, std::hypot((*hHCmass_pip)()->GetBinError  (AXmz.nbin() + ib), (*hHCmass_pin)()->GetBinError  (AXmz.nbin() - ib + 1)));
        }
        
        hCKmz->style(Line(kBlue, 0, 2.0), Marker(kBlue, MarkerStyle(MarkerShape::kCircle,  MarkerType::kFull)));
        hHCmz->style(Line(kRed,  0, 2.0), Marker(kRed,  MarkerStyle(MarkerShape::kDiamond, MarkerType::kFull)));
        THStack* hmz = Hist::Collect("hmz", HistList({ hCKmz, hHCmz }));
        
        editor.create();
        editor.cd(0, PadAxis(0, 1));
        hmz->Draw("nostack hist");
        hmz->SetMinimum(0.1);
        hmz->GetHistogram()->GetXaxis()->CenterTitle();
        hmz->GetHistogram()->SetLineColor(0);
        hmz->GetHistogram()->SetMarkerColor(0);
        hmz->GetHistogram()->GetXaxis()->SetTitle("|Mass/Charge| (|M/Z|) [GV/c^{2}]");
        hmz->GetHistogram()->GetYaxis()->SetTitle("Events / Bin");
        hmz->Draw("nostack hist");
        Legend leg_mz("", TextStyle(kBlack, 20, 43), PadWindow(0.50, 0.85, 0.15, 0.35));
        leg_mz()->AddEntry((TObject*)0, "Data (05/24/2011 ~ 12/14/2018)", "");
        leg_mz()->AddEntry((TObject*)0, "|Z|=1 & (0.50 < #beta < 0.80)", "");
        leg_mz()->AddEntry((*hCKmz)(), "Official fitting", "l");
        leg_mz()->AddEntry((*hHCmz)(), "FPM fitting", "l");
        leg_mz.draw();
        TextDraw("D"  , TextStyle(kBlack, 0.05), TextAlign(0.62, 0.80));
        TextDraw("p"  , TextStyle(kBlack, 0.05), TextAlign(0.36, 0.83));
        TextDraw("K"  , TextStyle(kBlack, 0.05), TextAlign(0.23, 0.70));
        TextDraw("#pi", TextStyle(kBlack, 0.05), TextAlign(0.15, 0.78));
        editor.save();
        
        hHCmz_d ->style(Line(kMagenta+1, 0, 2.0), Marker(kMagenta+1, MarkerStyle(MarkerShape::kSquare,       MarkerType::kFull)));
        hHCmz_p ->style(Line(kBlue,      0, 2.0), Marker(kBlue,      MarkerStyle(MarkerShape::kCross,        MarkerType::kFull)));
        hHCmz_k ->style(Line(kYellow+1,  0, 2.0), Marker(kYellow+1,  MarkerStyle(MarkerShape::kTriangleUp,   MarkerType::kFull)));
        hHCmz_pi->style(Line(kGreen+1,   0, 2.0), Marker(kGreen+1,   MarkerStyle(MarkerShape::kTriangleDown, MarkerType::kFull)));
        THStack* hFITmz = Hist::Collect("hFITmz", HistList({ hHCmz_d, hHCmz_p, hHCmz_k, hHCmz_pi }));
        
        editor.create();
        editor.cd(0, PadAxis(0, 1));
        (*hHCmz)()->SetMinimum(0.1);
        (*hHCmz)()->GetXaxis()->CenterTitle();
        (*hHCmz)()->GetXaxis()->SetTitle("|Mass/Charge| (|M/Z|) [GV/c^{2}]");
        (*hHCmz)()->GetYaxis()->SetTitle("Events / Bin");
        (*hHCmz)()->Draw("hist");
        hFITmz->Draw("nostack hist same");
        //hHCmz->draw("hist same");
        hHCmz->draw("pe same");
        Legend leg_FITmz1("", TextStyle(kBlack, 20, 43), PadWindow(0.42, 0.42, 0.13, 0.22));
        leg_FITmz1()->AddEntry((TObject*)0, "Data (05/24/2011 ~ 12/14/2018)", "");
        leg_FITmz1()->AddEntry((TObject*)0, "|Z|=1 & (0.50 < #beta < 0.80)", "");
        leg_FITmz1.draw();
        Legend leg_FITmz2("", TextStyle(kBlack, 20, 43), PadWindow(0.42, 0.62, 0.23, 0.43));
        leg_FITmz2()->AddEntry((*hHCmz)(), "Data", "lp");
        leg_FITmz2()->AddEntry((*hHCmz_d )(), "MC D", "l");
        leg_FITmz2()->AddEntry((*hHCmz_p )(), "MC p", "l");
        leg_FITmz2()->AddEntry((*hHCmz_k )(), "MC K", "l");
        leg_FITmz2()->AddEntry((*hHCmz_pi)(), "MC #pi", "l");
        leg_FITmz2.draw();
        TextDraw("D"   , TextStyle(kMagenta+1, 0.05), TextAlign(0.62, 0.80));
        TextDraw("p"   , TextStyle(kBlue,      0.05), TextAlign(0.36, 0.83));
        TextDraw("K"   , TextStyle(kYellow+1,  0.05), TextAlign(0.23, 0.70));
        TextDraw("#pi" , TextStyle(kGreen+1,   0.05), TextAlign(0.15, 0.78));
        editor.save();
