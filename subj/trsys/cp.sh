...
do
    ...
    #sh /ams_home/hchou/AMSProject/jobs/NCU/xrdcp_cern2ncu.sh /eos/ams/user/h/hchou/AMSData/prod/18Dec23/MC_HE4_216000.B1200 /ams02/user/hchou/MC_HE4_216000.B1200_18Dec23 YiNtuple_MC.${ii} &
    ...
    sh /ams_home/hchou/AMSProject/jobs/NCU/xrdcp_cern2ncu.sh /eos/ams/user/h/hchou/AMSData/prod/19Jan04/CERN_TEST /ams02/user/hchou/iss.pass7.B1130_19Jan04 YiNtuple_ISS.${ii} &
done
