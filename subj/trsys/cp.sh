...
do
    ii=`printf "%05d" $id`
    sh /ams_home/hchou/AMSProject/jobs/NCU/xrdcp_cern2ncu.sh /eos/ams/user/h/hchou/AMSData/prod/18Jul04/PR054000.B1200 /ams02/user/hchou/PR054000.B1200_18Jul04 YiNtuple_MC.${ii} &
