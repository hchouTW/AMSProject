...
do
    ...
    #sh /ams_home/hchou/AMSProject/jobs/NCU/xrdcp_cern2ncu.sh /eos/ams/user/h/hchou/AMSData/prod/19Jan12/CERN_TEST3 /ams02/user/hchou/iss.pass7.B1130_19Jan12 YiNtuple_ISS.${ii} &
    ...
    sh /ams_home/hchou/AMSProject/jobs/NCU/xrdcp_cern2ncu.sh /eos/ams/user/h/hchou/AMSData/prod/19Mar27/NEW_RICH_v2 /ams02/user/hchou/iss.pass7.B1130_19Mar27 YiNtuple_ISS.${ii} &
done
