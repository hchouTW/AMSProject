...
do
    ...
    sh /ams_home/hchou/AMSProject/jobs/NCU/xrdcp_cern2ncu.sh /eos/ams/user/h/hchou/AMSData/prod/18Dec23/CERN_TEST /ams02/user/hchou/iss.pass7.B1130_18Dec23 YiNtuple_ISS.${ii} &
done
