...
int main(int argc, char * argv[]) {
    ...
    TFile * ofle = new TFile("hit_fit2.root", "RECREATE");
    ofle->cd();
...
/*
    ...
    for (int it = 1; it <= AXeta.nbin() && it <= 144; ++it) {
        ...
        func->SetParameters(1000, kpa, mpv, 0.8);
        ...
        (*vhAdc.at(it))()->Fit(func, "q0", "", mpv-5*func->GetParameter(3), mpv+8*func->GetParameter(3));
        (*vhAdc.at(it))()->Fit(func, "q0", "", mpv-2*func->GetParameter(3), mpv+30*func->GetParameter(3));
        (*vhAdc.at(it))()->Fit(func, "q0", "", mpv-2*func->GetParameter(3), mpv+30*func->GetParameter(3));
