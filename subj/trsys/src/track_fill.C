...
int main(int argc, char * argv[]) {
    ...
    for (Long64_t entry = 0; entry < dst->GetEntries(); ++entry) {
        ...
        //if (fG4mc->primPart.mom > 0.8) continue; // testcode
        //if (fG4mc->primPart.mom < 100.0) continue; // testcode
