...
\documentclass[review]{/home/hchou/AMSProject/sw/tex/elsarticle-template/elsarticle}
...
\bibliographystyle{/home/hchou/AMSProject/sw/tex/elsarticle-template/elsarticle-num}
%%%%%%%%%%%%%%%%%%%%%%%
...
%\paragraph{Propagation} It uses Runge-K
...
%Here are two sample references: \cite{Strandlie2010}.
=======
Here are two sample references: \cite{Feynman1963118,Dirac1953888}.
Here are two sample references: \cite{Strandlie2010}.
>>>>>>> origin/master

\paragraph{Propagation} It uses RK4 method.
...
%\bibliographystyle{~/AMSProject/sw/tex/elsarticle-template/elsarticle-num}
%\bibliographystyle{/home/hchou/AMSProject/sw/tex/elsarticle-template/elsarticle-num}
\bibliography{note}
>>>>>>> origin/master
