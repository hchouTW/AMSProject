...
namespace MatAms {
    // TRK
    constexpr Double_t                             TRL1_STP = Numc::ONE<> / Numc::SIX<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRL1_N   {  65,  45,            1 };
    ...
    constexpr Double_t                             TRL2_STP = Numc::ONE<> / Numc::SIX<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRL2_N   {  65,  45,           1 };
    ...
    constexpr Double_t                             TRL3_STP = Numc::ONE<> / Numc::SIX<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRL3_N   {  55,  55,           1 };
    ...
    constexpr Double_t                             TRL4_STP = Numc::ONE<> / Numc::SIX<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRL4_N   {  55,  55,           1 };
    ...
    constexpr Double_t                             TRL5_STP = Numc::ONE<> / Numc::SIX<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRL5_N   {  55,  55,          1 };
    ...
    constexpr Double_t                             TRL6_STP = Numc::ONE<> / Numc::SIX<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRL6_N   {  55,  55,           1 };
    ...
    constexpr Double_t                             TRL7_STP = Numc::ONE<> / Numc::SIX<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRL7_N   {  55,  55,            1 };
    ...
    constexpr Double_t                             TRL8_STP = Numc::ONE<> / Numc::SIX<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRL8_N   {  55,  55,            1 };
    ...
    constexpr Double_t                             TRL9_STP = Numc::ONE<> / Numc::SIX<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRL9_N   {  50,  30,             1 };
    ...
    // TR Inner
    constexpr Double_t                             TR34_STP = Numc::ONE<> / Numc::FOUR<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TR34_N   {   370,   370,           8 };
    constexpr std::array<Double_t, MATGEOBOX_NDIM> TR34_MIN { -55.5, -55.5, TRL4_MAX[2] };
    constexpr std::array<Double_t, MATGEOBOX_NDIM> TR34_MAX {  55.5,  55.5, TRL3_MIN[2] };
    
    constexpr Double_t                             TR56_STP = Numc::ONE<> / Numc::FOUR<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TR56_N   {   370,   370,           8 };
    constexpr std::array<Double_t, MATGEOBOX_NDIM> TR56_MIN { -55.5, -55.5, TRL6_MAX[2] };
    constexpr std::array<Double_t, MATGEOBOX_NDIM> TR56_MAX {  55.5,  55.5, TRL5_MIN[2] };
    
    constexpr Double_t                             TR78_STP = Numc::ONE<> / Numc::FOUR<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TR78_N   {   370,   370,           8 };
    constexpr std::array<Double_t, MATGEOBOX_NDIM> TR78_MIN { -55.5, -55.5, TRL8_MAX[2] };
    constexpr std::array<Double_t, MATGEOBOX_NDIM> TR78_MAX {  55.5,  55.5, TRL7_MIN[2] };
    
    constexpr Double_t                             TRS1_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRS1_N   {  65,  45,            1 };
    ...
    constexpr Double_t                             TRS2_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRS2_N   {  65,  45,           1 };
    ...
    constexpr Double_t                             TRS3_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRS3_N   {  55,  55,           1 };
    ...
    constexpr Double_t                             TRS4_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRS4_N   {  55,  55,           1 };
    ...
    constexpr Double_t                             TRS5_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRS5_N   {  55,  55,           1 };
    ...
    constexpr Double_t                             TRS6_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRS6_N   {  55,  55,           1 };
    ...
    constexpr Double_t                             TRS7_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRS7_N   {  55,  55,            1 };
    ...
    constexpr Double_t                             TRS8_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRS8_N   {  55,  55,            1 };
    ...
    constexpr Double_t                             TRS9_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRS9_N   {  55,  55,           3 };
    ...
    // RAD
    constexpr Double_t                             RAD_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> RAD_N    {  120,  120,          10 };
    ...
    // TRD
    constexpr Double_t                             TRD_STP = Numc::ONE<> / Numc::FOUR<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TRD_N    {   220,  220,    20 };
    ...
    // SUPU
    constexpr Double_t                             SUPU_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> SUPU_N   {  130, 130,     5 };
    ...
    // TOFU
    constexpr Double_t                             TOFU_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TOFU_N   { 260, 260,    10 };
    ...
    // SPIU
    constexpr Double_t                             SPIU_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> SPIU_N   {  130, 130,     5 };
    ...
    // SPIL
    constexpr Double_t                             SPIL_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> SPIL_N   {  130, 130,      5 };
    ...
    // TOFL
    constexpr Double_t                             TOFL_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> TOFL_N   { 260, 260,     10 };
    ...
    // SUPL
    constexpr Double_t                             SUPL_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> SUPL_N   {  130, 130,      5 };
    ...
    // RICH
    constexpr Double_t                             RICH_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> RICH_N   {  65,  65,     6 };
    ...
    // PMT
    constexpr Double_t                             PMT_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> PMT_N    {  65,  65,      5 };
    ...
    // ECAL
    constexpr Double_t                             ECAL_STP = Numc::ONE<> / Numc::THREE<>;
    constexpr std::array<Long64_t, MATGEOBOX_NDIM> ECAL_N   {  42,  42,          10 };
