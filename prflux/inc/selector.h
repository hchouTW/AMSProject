...
class Selector {
    ...
    public :
        Selector(TChain* chain) { init(); set_branch(chain); }
        ~Selector() { init(); }
...
inline void Selector::set_branch(TChain* chain) {
...
void Selector::set_output(const std::string& outpath) {
    ...
    varsFLX.set_tree("varsFLX", "data");
    varsLTF.set_tree("varsLTF", "data");
    varsLRH.set_tree("varsLRH", "data");
    varsIIN.set_tree("varsIIN", "data");
    varsIEX.set_tree("varsIEX", "data");
    varsHEX.set_tree("varsHEX", "data");
    varsHFS.set_tree("varsHFS", "data");
