...
int main() {
    ...
    TString inputS = "/eos/ams/user/h/hchou/AMSData/proj/apflux/20Jan15/dataset.HEXp.iss22.root";
    TString inputB = "/eos/ams/user/h/hchou/AMSData/proj/apflux/20Jan15/dataset.HEXn.mcpr_l1o9flux22.root";
