/********************************************************************
* /afs/cern.ch/user/h/hchou/AMSProject/mrun/obj/dict.h
* CAUTION: DON'T CHANGE THIS FILE. THIS FILE IS AUTOMATICALLY GENERATED
*          FROM HEADER FILES LISTED IN G__setup_cpp_environmentXXX().
*          CHANGE THOSE HEADER FILES AND REGENERATE THIS FILE.
********************************************************************/
#ifdef __CINT__
#error /afs/cern.ch/user/h/hchou/AMSProject/mrun/obj/dict.h/C is only for compilation. Abort cint.
#endif
#include <stddef.h>
#include <stdio.h>
#include <stdlib.h>
...
#include "/afs/cern.ch/user/h/hchou/AMSProject/mrun/inc/ClassDef.h"
#include <algorithm>
namespace std { }
using namespace std;
