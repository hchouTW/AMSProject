...
CLANGTag=8.0.0
CLANGDir=/cvmfs/sft.cern.ch/lcg/contrib/clang/${CLANGTag}/x86_64-slc6
...
#### EOS %% Eigen Libs
#EigenDir=/eos/ams/user/h/hchou/ExternalLibs/LIBS/external/eigen3
EigenDir=/eos/user/h/hchou/ExternalLibs/LIBS/external/eigen3
